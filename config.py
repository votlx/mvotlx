...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "v_o_t_l")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "t_8_t_t")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5339932680").split()))
...
UPSTREAM_REPO = getenv("https://github.com/votlx/votlx")
